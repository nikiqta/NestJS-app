...
export interface UserModel extends Model<UserDocument> {
  seedAdminUser(): Promise<UserDocument | void>;
}
...
export class User {
  ...
  @Prop({ type: MongooseSchema.Types.String, required: true, maxLength: 20 })
  firstName;
...
// ✅ Static method: UserModel.seedAdminUser()
